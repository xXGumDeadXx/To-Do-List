...
@section('content')
    ...
    <section class="flex flex-col gap-6 md:flex-row md:gap-8 justify-center items-center">
        <div class="flex justify-center flex-col items-center w-full max-w-xs h-44 aspect-square rounded-2xl shadow-lg bg-gradient-to-b from-amber-300 to-amber-500 mb-4 md:mb-0 gap-4 hover:scale-105 transition-transform  dark:from-amber-500 dark:to-amber-700">
        ...
        <div class="flex justify-center flex-col items-center w-full max-w-xs h-44 aspect-square rounded-2xl shadow-lg bg-gradient-to-b from-green-300 to-green-500 mb-4 md:mb-0 gap-4 hover:scale-105 transition-transform dark:from-green-500 dark:to-green-700">
            <h2 class="text-lg md:text-2xl text-white font-semibold flex items-center gap-2">
            ...
            <p class="text-3xl md:text-4xl text-white font-bold">{{$infoTasks->completed}}</p>
                ...
                <div class="flex justify-center flex-col items-center w-full max-w-xs h-44 aspect-square rounded-2xl shadow-lg bg-gradient-to-b from-red-300 to-red-500 gap-4 hover:scale-105 transition-transform dark:from-red-400 dark:to-red-800">
            <h2 class="text-lg md:text-2xl text-white font-semibold flex items-center gap-2">
        ...
        <div class="flex justify-center flex-col items-center w-full max-w-xs h-44 aspect-square rounded-2xl shadow-lg bg-gradient-to-b from-blue-300 to-blue-500 gap-4 hover:scale-105 transition-transform dark:from-blue-500 dark:to-cyan-800">
            <h2 class="text-lg md:text-2xl text-white font-semibold flex items-center gap-2">
                <img class="w-6 h-6 text-white" src="{{ asset('icons/lists.svg')}}">
                </img>
                Tareas totales
