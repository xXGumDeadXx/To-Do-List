        ...
        <div class="bg-white p-6 rounded-lg shadow-md border border-gray-200 dark:bg-gray-800 dark:border-gray-700">
            <form action="{{ route('tasks.update', ['id' => $infoTask->id]) }}" method="POST" class="space-y-6">
                ...
                <div class="flex justify-between">
                    <button
                        type="submit"
                        class="px-4 py-2 bg-amber-600 text-white rounded-md hover:bg-amber-700 focus:outline-none focus:ring-2 focus:ring-amber-500 focus:ring-offset-2 dark:bg-amber-700 dark:hover:bg-amber-800 hover:scale-105 transition-transform cursor-pointer "
                    >
                        Guardar Tarea
                    </button>
                </div>
